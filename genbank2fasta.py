...
lies on the antisense strand, and written in FASTA format. By default one file
is written per gene; a single multi-FASTA file can be produced instead.
...
if __name__ == "__main__":
    ...
    print("Genes written to genes.fasta")
